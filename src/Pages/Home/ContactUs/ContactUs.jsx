              ...
              <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="flex-shrink-0 w-full rounded-tl-[50px] rounded-br-[50px] max-w-sm  lg:m-14">
                  <form className="card-body">
                    ...
                    <div className="form-control">
                      <input type="email" placeholder="Your E-mail" className="input input-bordered" required />
                    </div>
                    <div className="form-control">
                    <textarea type="text" placeholder="Your Message" name="description" className="input input-bordered pt-3 h-20" required />
                    </div>
