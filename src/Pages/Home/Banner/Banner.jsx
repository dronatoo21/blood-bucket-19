        ...
        <div>
            <div className="hero h-[200px] md:h-[400px] lg:h-[600px]" style={{backgroundImage: 'url(https://i.ibb.co/0ZxSTfq/12.jpg)'}}>
                ...
                <div className="w-full px-4 md:px-10">
                  ...
                  <button className="btn w-24 md:w-auto bg-[#0a3d62] text-white">Join as a donor</button>
                  <button className="btn w-24 md:w-auto bg-[#b33939] text-white ml-5">Search Donors</button>
                </div>
            </div>
        </div>
    );
