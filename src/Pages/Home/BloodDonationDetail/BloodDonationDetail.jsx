...
const BloodDonationDetail = () => {
    ...
    return (
        <div className="px-4">
            <h1 className="font-bold text-3xl text-center my-10 mb-2">Top Donors!</h1>
            <div className="card bg-base-100 shadow-xl mb-5">
              <div className="card-body">
                ...
                <div className="card-actions">
                    <button className="btn my-4 bg-gradient-to-r from-[#0a3d62] to bg-[#b33939] text-white" onClick={()=>document.getElementById('my_modal_5').showModal()}>Donate</button>
